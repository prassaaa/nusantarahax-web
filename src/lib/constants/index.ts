...
export const TESTIMONIALS = [
  ...
  },
  {
    ...
    rating: 5,
    comment: 'Been using NusantaraHax tools for over a year now. The quality is consistent and updates are always on time. Never had any ban issues!',
    productId: 'mlbb-pro',
    isVerified: true,
  ...
  },
  {
    ...
    rating: 5,
    comment: 'The aimbot is insane! My K/D ratio went from 1.2 to 4.5 in PUBG Mobile. Installation was super easy and the interface is user-friendly.',
    productId: 'pubgm-aimbot-pro',
    isVerified: true,
